...
class ServiceDetail(StateEVCC):
    ...
    async def build_service_selection_req(self) -> ServiceSelectionReq:
        ...
        service_selection_req = ServiceSelectionReq(
            ...
            selected_vas_list=SelectedServiceList(selected_services=selected_vas_list) if selected_vas_list else None,
        )
...
class DCChargeParameterDiscovery(StateEVCC):
    ...
    async def process_message(
        ...
        dc_cpd_res: DCChargeParameterDiscoveryRes = cast(DCChargeParameterDiscoveryRes, msg)
        cp = dc_cpd_res.dc_params or dc_cpd_res.bpt_dc_params
